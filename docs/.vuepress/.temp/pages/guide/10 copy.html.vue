...
<p>首先我们来看下面这段代码：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>function bar() {
  console.log(myName)
}
function foo() {
  var myName = "极客邦"
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>var bar = {
